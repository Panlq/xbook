...
5. [Kubernetes 文档/参考/API 访问控制/用户认证](https://kubernetes.io/zh-cn/docs/reference/access-authn-authz/authentication/)
6. [什么是认证 | Authing 文档](https://docs.authing.cn/v2/concepts/authentication.html)
7. [什么是授权 | Authing 文档](https://docs.authing.cn/v2/concepts/authorization.html)
8. [Kubernetes——X.509 数字证书认证 - 左扬 - 博客园](https://www.cnblogs.com/zuoyang/p/16437585.html)
9. [什么是 x.509 证书及其工作原理 - SSL Dragon](https://www.ssldragon.com/zh/blog/what-is-x-509-certificate/#x509-work)
10. [从里到外的 HTTPS 证书(X509)详解 – Snow Star 博客](https://snowstar.org/2022/11/27/a-deep-look-at-x509/)
